class Api::V1::WatchableSerializer
 ...
 attribute :thumbnail_url do |object|
   AWS_BUCKET.object("thumbnail/#{object.thumbnail_key}").presigned_url(:get, expires_in: 120)
 end

 attribute :thumbnail_cover_url do |object|
   AWS_BUCKET.object("thumbnail/#{object.thumbnail_cover_key}").presigned_url(:get, expires_in: 120)
 end
 ...
 attribute :featured_thumbnail_url do |object|
  if object[:featured_thumbnail_key].present?
    AWS_BUCKET.object("thumbnail/#{object.featured_thumbnail_key}").presigned_url(:get, expires_in: 120)
  end
 end
end
